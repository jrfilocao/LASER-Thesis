...
sys.path.append(NEWS_TASK + '/extraction/de_pt_corpus')

import re
import syntok.segmenter as segmenter

from de_pt_article_id_sentence_extractor import extract_single_article_from_file
