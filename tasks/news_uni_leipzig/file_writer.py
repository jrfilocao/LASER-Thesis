...
def write_id_sentence_pair_to_file(output_file, article_index, sentence, sentence_index):
...
def write_sentence_id_to_file(output_file, article_index, sentence_index):
    sentence_id = _get_sentence_id(article_index, sentence_index)
