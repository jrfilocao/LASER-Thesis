...
extract_sentences () {
  python3 ${NEWS_TASK}/extraction/de_pt_corpus/de_pt_article_extractor.py
}
...
create_reports () {
  ...
  python3 ${NEWS_TASK}/reporting/de_pt_article_pairs_report_creator.py --output-report-base-file-name ${output_directory}/report
}
