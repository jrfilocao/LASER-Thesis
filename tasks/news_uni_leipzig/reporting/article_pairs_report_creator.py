...
if __name__ == "__main__":
    # de_pt_file_path = '../input_files/unique_de_pt.txt'
    # en_de_file_path = '../input_files/unique_en_de.txt'
    # en_pt_file_path = '../input_files/unique_en_pt.txt'
    ...
    #create_multi_metric_diagrams('invalid_pair_count', de_pt_metric_keys, de_pt_metrics, 'de_pt')
    #
    ...
    #create_multi_metric_diagrams('invalid_pair_count', en_pt_metric_keys, en_pt_metrics, 'en_pt')
    #
    ...
    #create_multi_metric_diagrams('invalid_pair_count', en_de_metric_keys, en_de_metrics, 'en_de')
    #
